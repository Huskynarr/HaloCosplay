...
## Begleiter als optionale Halo-Inszenierung

Ein Roboterhund mit austauschbarem Originalsender am Anzug ist der erste
Entwicklungspfad. Drohnenaufnahmen und humanoide Begleitung werden getrennt
geplant. Aktuelle Modellunterschiede, SDK-Grenzen, Funkkassette und Testfolge
stehen im [Begleitguide](../../Documentation/Guides/Begleitroboter-Integration.md),
Kosten und Lieferumfang in der [Hardwareliste](../../Materials/Mjolnir-Begleitsystem.md).

Die frueheren pauschalen Aussagen zu UWB, Messezulassung, Laufzeit und Preisen
sind dort durch modellbezogene Herstellerbelege ersetzt. Eine UDP-HUD-Bruecke
ist noch kein Roboter-Folgeprogramm. Halo-Verkleidungen bleiben abnehmbar und
muessen Sensoren, Antennen, Kuehlung und Gelenke freilassen.
