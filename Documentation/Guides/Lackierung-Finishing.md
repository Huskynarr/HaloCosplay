...
- Nach dem Glaetten eine letzte Schicht **normaler Primer** (nicht Filler) fuer gleichmaessige Basis
...
2. **Dry Brushing (Kantenwetter):**
   ...
   - Leicht ueber Kanten, Ecken und erhabene Details ziehen = erste Verschleissschicht
   - Zweite Schicht mit **Silber/Gunmetal Metallic** auf Ecken und Kanten = simuliert freigelegtes Metall
...
4. **Schwammtechnik:**
   - Kuechenschwamm abreissen, in Dunkelbraun/Schwarz tauchen, Ueberschuss abtupfen, leicht auf Flaechen druecken = Schmutz-/Schmutztextur

5. **Pigmentpulver:**
   - Trockene Pigmente (Erdtoene, Rost, Russ) in Vertiefungen einpinseln und mit mattem Klarlack versiegeln
...
- Klarlack **nach Abschluss aller Weathering-Arbeiten** auftragen
- Unterliegende Farbe **2-3 Tage voll durchtrocknen** lassen
- **3-4 duenne Schichten**, keine dicke einzelne Schicht
- **An Probestueck testen** bevor auf Ruestung auftragen
...
1. Visor-Buck (Positivform) drucken oder schnitzen, etwas kleiner als Helm-Oeffnung
2. PETG-Folie in Rahmen einspannen, auf ca. 140-155 C erwaermen bis sie durchhaengt
3. Ueber Buck legen und Vakuum anlegen
4. Mit Schere oder Dremel zuschneiden

### Gold/Chrome Toenung (Zwei-Schritt-Methode, 405th)

1. **PETG faerben:** **iDye Poly** (Gold oder Orange) im Heisswasserbad. Farbe bindet sich dauerhaft durch Hitzetransfer an den Kunststoff.
2. **Innenseite verspiegeln:** **Krylon Looking Glass Mirror-Like Paint** auf die **Innenseite** spruehen. Technik: in die Luft spruehen und Visor durch den Nebel fuehren fuer duenne, gleichmaessige Reflexionsschicht. Mehrere Durchgaenge fuer mehr Reflexion bei Durchsicht von innen.

**Haltbarkeit:** Chrome-Schicht auf Innenseite kann durch Feuchtigkeit/Beruehrung leiden. Kann abgewischt und neu aufgetragen werden. Optional duenner Klarlack ueber Chrome innen zum Schutz.

**Alternative:** Vorgefertigte Gold-Motorradvisier-Einsaetze oder Schweisskappen-Toenungsfolie innen aufkleben.
