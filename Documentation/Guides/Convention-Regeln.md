...
- **Strengste Regelung:** ALLE Waffenimitationen und waffenaehnliche Kostuemteile werden am Eingang eingezogen, unabhaengig von Material oder Groesse
- Cosplayer sollen Waffen-Props komplett zu Hause lassen
...
- Showkaempfe verboten
- DoKomi Cosplayball: Ruestung, Hartplastik, Metall, Helme sind **nicht erlaubt**

## Manga Comic Con Leipzig (MCC)

Detaillierteste Regeln aller deutschen Conventions:

- **Groesseneinschraenkungen:**
  - Gesamthoehe max 2,5 m
  - Roecke max 2 m Durchmesser
  - Fluegel max 1 m pro Seite
...
- Props am Eingang durch "Cosplay Safety Check" Team geprueft und markiert
- **Verboten:** Metall-Schusswaffenrepliken, massive Holz-/Hartplastikklingen, Staebe/Rohre aus Holz/Metall/Glasfaser/Hartplastik, verschussfaehige Pfeile
- Jede Waffe wird vor Ort einzeln beurteilt
- Eingezogene Gegenstaende werden verwahrt und beim Verlassen zurueckgegeben

## Comic Con Stuttgart (CCON)

- Foam, Gummi, Pappe, weicher Kunststoff erlaubt
- Nicht-funktionale Boegen max 1,50 m mit Attrappen-Pfeilen erlaubt
- Metallruestungsteile fest am Koerper befestigt erlaubt; lose Metallteile muessen beim Cosplay-Check vorgezeigt werden

## Allgemeine Muster (alle deutschen Cons)

- **Fotos vorab senden** und Freigabe erbitten (von allen Conventions empfohlen)
- Handler mitbringen bei grossen Builds
- Kostuem muss durch Standardtueren passen
...
- Anscheinswaffen muessen in **geschlossenen, blickdichten Behaeltern** transportiert werden
- Vom Auto zum Con-Eingang: Props in Taschen/Koffern, NICHT offen durch die Stadt tragen

## Prop-Empfehlung fuer Master Chief
