...
- **Luftpolsterfolie** um detaillierte/lackierte Flaechen
- Weiches Tuch zwischen verschachtelten Teilen
- **Poolnudeln** als Abstandhalter zwischen grossen Teilen
- Plastiktueten ueber frisch lackierte Bereiche (Scheuerschutz)
- Scharfe Kanten abdecken (schuetzt andere Teile UND dich)

## Modulare Demontage

- Ruestung von Anfang an mit Magnet-/Klett-/Schnappverbindungen planen
- Jedes Teil fotografieren und Orientierung/Befestigungspunkte dokumentieren
- Teile mit Maler-Tape nummerieren bei vielen aehnlichen Stuecken
- Gedruckten Montageguide mitfuehren
...
## Oeffentliche Verkehrsmittel (wenn noetig)

- Props muessen in **geschlossenen, blickdichten Behaeltern** sein (Waffengesetz!)
- Stosszeiten vermeiden
- Grosse IKEA-Taschen (Frakta) fuer leichtere Ruestungsteile
- Helm in separater gepolsterter Tasche
- Ggf. mehrere Fahrten einplanen oder Hilfe organisieren
