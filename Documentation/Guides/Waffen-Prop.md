...
| SPNKr Raketenwerfer | 100-120 cm | Schwer | Problematisch (realistischer Look) |
...
- Am Veranstaltungsort auspacken, NICHT vorher
...
### Option 1: EVA-Foam + PVC-Kern (empfohlen fuer Cons)

**Vorteile:** Leicht, con-sicher, guenstig, stabil genug fuer Fotoshootings

**MA5 Assault Rifle Bau-Ablauf:**

1. **Kern:** PVC-Rohr (20 mm Durchmesser) auf ca. 80 cm zugeschnitten als Rueckgrat
2. **Grundform:** 10 mm EVA-Foam-Platten um den Kern kleben (Kontaktkleber)
...
**Vorteile:** Hoehere Detailtreue, exakte Nachbildung

1. STLs herunterladen (Galactic Armory, 405th, Thingiverse)
2. In Segmenten drucken (H2C Bauvolumen beachten)
...
Bester Kompromiss:
- Grundkoerper aus Foam (leicht, con-sicher)
- Detailteile 3D-gedruckt (Magazin, Visierung, Griff-Details)
- Ergibt guten Detailgrad bei geringerem Gewicht

## Con-sichere Gestaltung
...
- Gruen/blau leuchtende Visierung (2-3 WS2812B LEDs)
- Ammo-Counter Display (kleines OLED, anspruchsvoll aber episch)
- Daten-LED am Magazin
- Stromversorgung: kleiner LiPo oder AAA-Batterien im Griff

### Sound

- **DFPlayer Mini** (MP3-Player-Modul, ~3 EUR) + kleiner Lautsprecher
- Halo-Sounds auf microSD laden
...
- [ ] Keine Metallteile an Spitze/Klinge
- [ ] Kein beweglicher Abzug (kann als "realistisch" gewertet werden)
- [ ] Prop ist deutlich als kuenstlich erkennbar
- [ ] Farbe/Finish nicht 100% realistisch (Game-Stil, nicht Milsim)
- [ ] Gewicht angemessen (zu schwer = Verletzungsgefahr, zu leicht wirkt billig)
- [ ] Transport in geschlossener Tasche geplant
- [ ] Con-Regeln geprueft, ggf. Fotos eingesendet
