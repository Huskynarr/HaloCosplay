...
- Ruestung sauber und frei von Staub/Fingerabdruecken
- Visor frisch gereinigt (Anti-Beschlag vorher auftragen)
- LEDs geladen und funktionsfaehig
- Touch-Up Farbe fuer kurzfristige Kratzer
- Wasser und Handler dabei

## Locations

### Indoor (gut fuer kontrolliertes Licht)

- Hallen mit industriellem Look (Fabrik, Lager)
- Betonwaende, Metall-Strukturen
- Treppen und Gaenge (fuer dramatische Tiefe)
- Convention-Halle (Hintergrund austauschbar)
...
### Klassische Master Chief Posen

| Pose | Beschreibung | Wirkung |
| --- | --- | --- |
| Power Stance | Beine schulterbreit, leicht gebeugt, Haende an den Seiten | Staerke, Praesenz |
| Weapon Ready | Waffe auf Huefthoehe, leicht nach vorne geneigt | Action, Bereitschaft |
| Looking Up | Blick nach oben in den Himmel, Helm leicht geneigt | Episch, heroisch |
| Walking Shot | Mittendrin beim Gehen, natuerliche Bewegung | Dynamisch |
| Crouch | Geduckt, eine Hand am Boden | Taktisch, kampfbereit |
| Over Shoulder | Ruecken zur Kamera, Kopf leicht gedreht | Mysterioes, filmisch |
| Salute | Militaergruss | Ikonisch, feierlich |
